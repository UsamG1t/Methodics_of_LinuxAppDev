...
```console
user@localhost:~> ls | xargs echo "QQ"
...
user@localhost:~> ls | xargs -n1 echo "QQ"
QQ bin
QQ d
QQ d1
QQ d34
...
`Term1`
```console
user@localhost:~/LinuxAppDev/03_Text/Lection> sh mktemp_prog
Create a file? y
/tmp/tmp.0HpoFrspx2
-rw------+ 1 user user 0 Oct  1 17:26 /tmp/tmp.0HpoFrspx2
Wait…
```
...
user@localhost:~/LinuxAppDev/03_Text/Lection>
