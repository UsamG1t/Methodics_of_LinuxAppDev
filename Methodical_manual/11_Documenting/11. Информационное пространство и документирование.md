...
```console
user@localhost:~/LinuxAppDev/11_Documenting/Lection/namegen> doxygen -g Doxyfile.in 
...
user@localhost:~/LinuxAppDev/11_Documenting/Lection/namegen> 
```

```console
user@localhost:~/LinuxAppDev/11_Documenting/Lection/namegen> cat Doxyfile.in | wc
   2884   21302  129104
user@localhost:~/LinuxAppDev/11_Documenting/Lection/namegen> 
```
...
```console
user@localhost:~/LinuxAppDev/11_Documenting/Lection/namegen> man ./doxygen-doc/man/man1/namegen.c.1 
