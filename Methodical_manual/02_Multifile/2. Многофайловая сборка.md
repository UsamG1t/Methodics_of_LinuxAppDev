...
user@localhost: make prog
cc const.c -c -o const.o
cc fun.c -c -o fun.o
cc prog.c -c -o prog.o
cc const.o fun.o prog.o -o prog

user@localhost: touch fun.c 
user@localhost: make prog  
cc fun.c -c -o fun.o
cc const.o fun.o prog.o -o prog

user@localhost: touch fun.o
user@localhost: make prog  
cc const.o fun.o prog.o -o prog
```
...
```console
user@localhost:~/LinuxAppDev/02_Multifile> ./prog
1: <INIT>
2: <NOPE>
3: <DONE>
user@localhost:~/LinuxAppDev/02_Multifile> ./prog Hahaha
2: <INIT>
3: Hahaha
4: <DONE>
user@localhost:~/LinuxAppDev/02_Multifile> 
```
...
```console
user@localhost:~/LinuxAppDev/02_Multifile> make distclean
rm -f *.o *~ o.*
rm -rf prog README

user@localhost:~/LinuxAppDev/02_Multifile> make
cc const.c -c -o const.o
cc fun.c -c -o fun.o
cc prog.c -c -o prog.o
cc const.o fun.o prog.o -o prog
...
user@localhost:~/LinuxAppDev/02_Multifile> touch outlib.h 
user@localhost:~/LinuxAppDev/02_Multifile> make
make: Nothing to be done for 'all'.
```
...
```console
user@localhost:~/LinuxAppDev/02_Multifile> make distclean all
rm -f *.o *~ o.*
rm -rf prog README
cc const.c -c -o const.o
cc fun.c -c -o fun.o
...
```console
user@localhost:~/LinuxAppDev/02_Multifile/Lection> ar -rcs libout.a const.o fun.o
```
...
```console
user@localhost:~/LinuxAppDev/02_Multifile/Lection> cc prog.o -L. -lout -o prog
```
...
user@localhost:~/LinuxAppDev/02_Multifile> ./prog qwerty
2: <INIT>
3: qwerty
4: <DONE>

user@localhost:~/LinuxAppDev/02_Multifile> ./prog qwerty asdf
3: <INIT>
4: qwerty
5: asdf
6: <DONE>
...
user@localhost:~/LinuxAppDev/02_Multifile> cat README 
./prog v0.00: Print all arguments
	Usage: ./prog arg1 [arg2 […]]
