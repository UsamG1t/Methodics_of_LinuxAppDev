...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> ls
ffopen.c  ffopen_new.c
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> diff ffopen.c ffopen_new.c 
17c17
<     case 'x': /* "w+" */
---
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> diff -e ffopen.c ffopen_new.c 
17c
    case 'x': m = O_RDWR | O_CREAT | O_TRUNC; break; /* w+ */
.
```
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> diff -c ffopen.c ffopen_new.c 
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> diff -u ffopen.c ffopen_new.c 
--- ffopen.c	2024-11-12 16:32:10.603958261 +0300
+++ ffopen_new.c	2024-11-12 16:32:23.247503694 +0300
...
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> 
```
...
```concole
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> diff -u ffopen.c ffopen_new2.c 
--- ffopen.c	2024-11-12 16:32:10.603958261 +0300
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> diff -u ffopen.c ffopen_new.c > p0.patch 
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> ls
a.out  ffopen.c  ffopen_new2.c  ffopen_new.c  p0.patch
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> cat p0.patch 
--- ffopen.c	2024-11-12 16:32:10.603958261 +0300
+++ ffopen_new.c	2024-11-12 16:32:23.247503694 +0300
@@ -14,7 +14,7 @@
     case 'a': m = O_WRONLY | O_CREAT | O_APPEND; break;
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> diff -u ffopen_new.c ffopen_new2.c > p1.patch 
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> ls
a.out  ffopen.c  ffopen_new2.c  ffopen_new.c  p0.patch  p1.patch
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> cat p1.patch 
--- ffopen_new.c	2024-11-12 16:32:23.247503694 +0300
+++ ffopen_new2.c	2024-11-12 16:44:50.173769006 +0300
@@ -31,6 +31,7 @@
           perror(argv[1]);
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> cp ffopen.c ffopen2.c
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> patch ffopen2.c < p0.patch 
patching file ffopen2.c
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> diff ffopen2.c ffopen_new.c 
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> patch ffopen2.c < p1.patch 
patching file ffopen2.c
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> diff ffopen2.c ffopen_new2.c 
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> 
```
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> cat p*.patch > pall.patch 
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> cat pall.patch 
--- ffopen.c	2024-11-12 16:32:10.603958261 +0300
+++ ffopen_new2.c	2024-11-12 16:44:50.173769006 +0300
@@ -14,7 +14,7 @@
     case 'a': m = O_WRONLY | O_CREAT | O_APPEND; break;
...
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> patch --verbose ffopen3.c < pall.patch 
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> cc -Wall ffopen3.c
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> ./a.out /usr/bin/bzcat
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> patch --verbose ffopen4.c < pall.patch 
Hmm...  Looks like a unified diff to me...
The text leading up to this was:
--------------------------
|--- ffopen.c	2024-11-12 16:32:10.603958261 +0300
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection> cat ffopen4.c.rej 
--- ffopen.c	2024-11-12 16:32:10.603958261 +0300
+++ ffopen_new2.c	2024-11-12 16:44:50.173769006 +0300
@@ -14,7 +14,7 @@
     case 'a': m = O_WRONLY | O_CREAT | O_APPEND; break;
...
Для удобной работы с патчами cуществует отдельный набор утилит `patchutils`. Рассмотрим его работу на примере работы с календарём

```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> LC_TIME=ru_RU.UTF-8 cal -y > calend
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> cat calend
                               2024                               
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> sed -i.old1 's/21   13/21...13/' calend
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> diff -u calend.old1 calend > p1.patch
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> cat p1.patch 
...
```
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> sed -i.old2 's/ябрь/ёр../g' calend
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> diff -u calend.old2 calend > p2.patch
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> cat p2.patch 
...
```
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> sed -i.old3 's/[.]/ /g' calend
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> diff -u calend.old3 calend > p3.patch
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> cat p3.patch 
...
+       Октёр                  Ноёр                   Декабрь      
 Пн Вт Ср Чт Пт Сб Вс   Пн Вт Ср Чт Пт Сб Вс   Пн Вт Ср Чт Пт Сб Вс
     1  2  3  4  5  6                1  2  3                      1
  7  8  9 10 11 12 13    4  5  6  7  8  9 10    2  3  4  5  6  7  8
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> 
```
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> cat p?.patch > pall.patch
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> cat pall.patch 
--- calend.old1	2024-11-12 17:09:32.096205400 +0300
+++ calend	2024-11-12 17:09:49.309601942 +0300
@@ -12,7 +12,7 @@
 Пн Вт Ср Чт Пт Сб Вс   Пн Вт Ср Чт Пт Сб Вс   Пн Вт Ср Чт Пт Сб Вс
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> LC_TIME=ru_RU.UTF-8 cal -y > calend
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> patch --verbose < pall.patch 
Hmm...  Looks like a unified diff to me...
The text leading up to this was:
--------------------------
|--- calend.old1	2024-11-12 17:09:32.096205400 +0300
...
Всё корректно применяется, последовательно применяя преобразование. А теперь рассмотрим утилиты `patchutils`

##### `patchutils combinediff`
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> combinediff p1.patch p2.patch 
...
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> combinediff p1.patch p2.patch | combinediff - p3.patch 
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> interdiff p1.patch p2.patch 
diff -u calend calend
--- calend	2024-11-12 17:09:49.309601942 +0300
+++ calend	2024-11-12 17:10:11.596350457 +0300
@@ -12,11 +12,11 @@
...
```console
user@localhost:~/LinuxAppDev/09_PatchDiff/Lection/calend> rediff p1.patch 
--- calend.old1	2024-11-12 17:09:32.096205400 +0300
+++ calend	2024-11-12 17:09:49.309601942 +0300
@@ -16,7 +16,8 @@
 Пн Вт Ср Чт Пт Сб Вс   Пн Вт Ср Чт Пт Сб Вс   Пн Вт Ср Чт Пт Сб Вс
...
Рассмотрим пример
```console
user@localhost:~/test_repo> cal > txt
user@localhost:~/test_repo> cat txt
    November 2024   
...
user@localhost:~/test_repo> sed -i 's/1/\&/g' txt 
user@localhost:~/test_repo> cat txt 
    November 2024   
Su Mo Tu We Th Fr Sa
                &  2
...
```console
user@localhost:~/test_repo> git diff -u > p1.patch
user@localhost:~/test_repo> cat p1.patch 
...
user@localhost:~/test_repo>
user@localhost:~/test_repo> git add .
user@localhost:~/test_repo> git commit -m "2nd"
[master 7bc23e3] 2nd
...
```console
user@localhost:~/test_repo> cp p1.patch ~/p1.patch
user@localhost:~/test_repo> git reset --hard HEAD~
HEAD is now at 384275a 1st
user@localhost:~/test_repo> ls
txt
user@localhost:~/test_repo> cat txt 
    November 2024   
Su Mo Tu We Th Fr Sa
...
user@localhost:~/test_repo> git am < ~/p1.patch
Applying: 
user@localhost:~/test_repo> ls
txt
user@localhost:~/test_repo> cat txt 
