...
```console
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> make
gcc -fPIC -shared lib.c libg.c -o libinc.so
gcc -L. main.c -linc -o inc
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> make check
LD_LIBRARY_PATH=`pwd` ./inc 123
124
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> 
```
...
Разберём добавленные нами команды:
 ...
 + Для создания бинарного файла мы также в режиме компоновки объединяем архив с о-файлом тестирующей функции. Это, кстати, даёт нам возможность в тестирующем рецепте убрать явное указание места загрузки динамической библиотеки - `libtool` сам знает, куда положил библиотеку и сам её подключит
...
```console
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> ls
inc  lib.c  libg.c  lib.h  libinc.so  main.c  Makefile
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> make clean
rm -rf *.so inc .libs *.l? *.o
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> ls
...
```console
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> ls -a
.   inc    libg.c   libg.o  libinc.la  lib.o  main.c  Makefile
..  lib.c  libg.lo  lib.h   lib.lo     .libs  main.o
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> ls .libs/
...
```console
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> diff inc .libs/inc
Binary files inc and .libs/inc differ
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> ./inc 123
124
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> ./.libs/inc 123
./.libs/inc: error while loading shared libraries: libinc.so.0: cannot open shared object file: No such file or directory
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> LD_LIBRARY_PATH=`pwd`/.libs ./.libs/inc 123
124
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> 
```
...
```console
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> cat lib.lo
...
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> cat libinc.la 
...
```sh
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> cat inc
#! /usr/bin/bash
...
LD_LIBRARY_PATH="/home/user/LinuxAppDev/10_LibTesting/Lection/.libs:$LD_LIBRARY_PATH"
...
```console
user@localhost:~/LinuxAppDev/10_LibTesting/Lection> cd .libs/
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/.libs> la -A *.so*
lrwxrwxrwx 1 user user    15 Nov 25 07:55 libinc.so -> libinc.so.0.0.0
lrwxrwxrwx 1 user user    15 Nov 25 07:55 libinc.so.0 -> libinc.so.0.0.0
-rwxr-xr-x 1 user user 16624 Nov 25 07:55 libinc.so.0.0.0
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/.libs> 
```
...
```console
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy> tree
.
└── src
    ├── example.c
    ├── Makefile
...
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy> 
```
...
```console
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy> cd src/
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy/src> make
cc -pie -ansi -pedantic -Wall -Wextra -O3 -g3 -fpie -o namegen example.c 
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy/src> make check
PASS alternation
PASS substitution
...
PASS empty
All 15 tests passed
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy/src> 
```
...
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy> autoreconf -fisv
<...>
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy> ./configure 
<...>
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy> make demo
make  all-recursive
<...>
./src/namegen '!BVCs !DdM'
Thestit Thulfboo
...
```console
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy/src> tree
.
├── Makefile.am
├── namegen.c
├── namegen.h
...
Начнём готовить тестирующую библиотеку. Пока что просто разобьём тесты и заголовочные данные из `header`-файла
...
```console
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy> make check
Making check in src
make[1]: Entering directory '/home/user/LinuxAppDev/10_LibTesting/Lection/fantasy/src'
PASS alternation
PASS substitution
PASS closing bracket
PASS closing paren
...
PASS empty
All 15 tests passed
make[1]: Leaving directory '/home/user/LinuxAppDev/10_LibTesting/Lection/fantasy/src'
Making check in tests
make[1]: Entering directory '/home/user/LinuxAppDev/10_LibTesting/Lection/fantasy/tests'
make  check-TESTS
make[2]: Entering directory '/home/user/LinuxAppDev/10_LibTesting/Lection/fantasy/tests'
make[3]: Entering directory '/home/user/LinuxAppDev/10_LibTesting/Lection/fantasy/tests'
PASS: dummy
============================================================================
...
# ERROR: 0
============================================================================
make[3]: Leaving directory '/home/user/LinuxAppDev/10_LibTesting/Lection/fantasy/tests'
make[2]: Leaving directory '/home/user/LinuxAppDev/10_LibTesting/Lection/fantasy/tests'
make[1]: Leaving directory '/home/user/LinuxAppDev/10_LibTesting/Lection/fantasy/tests'
make[1]: Entering directory '/home/user/LinuxAppDev/10_LibTesting/Lection/fantasy'
make[1]: Leaving directory '/home/user/LinuxAppDev/10_LibTesting/Lection/fantasy'
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy> ^C
user@localhost:~/LinuxAppDev/10_LibTesting/Lection/fantasy> 
```
